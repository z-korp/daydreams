  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (data.response && data.response.content) {
        // Log the nested response content
        console.log("Nested response content:", data.response.content);
        // Clean XML tags if present
        content = data.response.content.replace(/<\/?content>/g, "");
      } else if (data.content) {
        // Log the original format content
        console.log("Original format content:", data.content);
        // Original format
        content = data.content;
      } else {
        // Log the fallback scenario
        console.log("Fallback: Response received but unexpected format");
        // Fallback
        content = "Response received but unexpected format";
      }
