...
A standalone AI trading agent for the GMX decentralized exchange, built with the Daydreams AI framework.
...
1. Download this GMX trading agent directory or copy it to your desired location
...
This will install the required Daydreams AI framework packages:
- `@daydreamsai/core` - Core agent framework
- `@daydreamsai/cli` - Command line interface extension
- AI SDK providers for OpenAI, Anthropic, and Groq
- GMX SDK for trading functionality
