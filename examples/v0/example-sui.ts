...
import {
  ...
  SuiNetwork,
  supportedSuiTokens,
} from "../packages/core/src/core/chains/sui";
  ...
  core.registerIOHandler({
    ...
    outputSchema: z.object({
      ...
      targetToken: z
        .string()
        .describe(
          `The token name to be swapped. It can be one of these: ${supportedSuiTokens}. This tokena and from token should not be same.`
        ),
      amount: z
        .string()
        .describe(
